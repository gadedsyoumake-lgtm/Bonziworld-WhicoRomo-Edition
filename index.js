...
var commands = {
  ...
  wtf:(victim, param)=>{
    ...
    const randomPhrase = wtfPhrases[Math.floor(Math.random() * wtfPhrases.length)];
    victim.room.emit("talk",{guid:victim.public.guid, text:randomPhrase});
  },
